...
CREATE TABLE `dy_user` (
    ...
    `follow_count` bigint(64) NOT NULL DEFAULT '0' COMMENT '关注总数',
    `follower_count` bigint(64) NOT NULL DEFAULT '0' COMMENT '粉丝总数',
    `total_favorite` bigint(64) NOT NULL DEFAULT '0' COMMENT '获赞总数',
    `work_count` bigint(64) NOT NULL DEFAULT '0' COMMENT '作品总数',
    `favorite_count` bigint(64) NOT NULL DEFAULT '0' COMMENT '点赞总数',
